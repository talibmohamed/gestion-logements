...
const ResidantTable = ({ columns, rows, title }) => {
  ...
  const [currentResidant, setCurrentResidant] = useState(null);
              ...
              <ModalBody>
                <div className="flex w-full flex-wrap md:flex-nowrap items-center justify-center gap-4 ">
                  <Input
                    type="text"
                    label="No Résidant"
                    placeholder="Entrer le no du résidant"
                    className="max-w-sm"
                    classNames={{
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">
                Modifier les détails du résidant
              </ModalHeader>
              <ModalBody>
                <div className="flex w-full flex-wrap md:flex-nowrap items-center justify-center gap-4">
                  <Input
            ...
            <>
              ...
              <ModalBody>
                <Input
                  ...
                  label="Résidant:"
                  variant="bordered"
                  defaultValue={currentResidant.id_res}
                  className="max-w-sm"
                  classNames={{
                    label: "group-data-[filled-within=true]:text-zinc-400",
                    input: [
...
ResidantTable.propTypes = {
  ...
  rows: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      id_res: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
        .isRequired,
