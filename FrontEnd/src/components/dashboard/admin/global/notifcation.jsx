...
import { fetchNotificationsThunk } from "../../../../session/thunks/adminthunk";
import {
  Dropdown,
  DropdownTrigger,
  DropdownMenu,
...
export default function App() {
  ...
  const formatTimeSince = (dateString) => {
    ...
    if (diffSeconds < 60) {
      ...
      // Format the date in DD/MM/YYYY or however you prefer
  ...
  // Function to mark notification as read (not shown in code)
  const markNotificationAsRead = (notifId) => {
    // Implement functionality to mark notification as read
  };
