    ...
    <>
      ...
      {isMobile ? (
        <Carousel showArrows={false} showStatus={false} showThumbs={false}>
          ...
          <Card className="w-full h-[254px] mb-10" shadow="none">
            ...
            <Divider />
            <CardBody>
              <p className="text-lg text-pretty font-normal mx-2.5">
            ...
            <Button  variant="light" color="warning" onPress={handleOpenModal}>
                Voir plus
              </Button>
              <Modal
          ...
          <Card className="w-full h-[254px]" shadow="none">
            <CardHeader className="flex gap-3">
              <AutoFixHighOutlinedIcon />
              <div className="flex flex-col">
                <h3 className="text-xl font-semibold">Equipements</h3>
              </div>
            </CardHeader>
            <Divider />
            <CardBody>
